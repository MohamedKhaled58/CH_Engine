...
CHInternal::RenderStateManager g_RenderStateManager;
CHInternal::CompatibilityShaderManager g_CompatibilityShaderManager;
          ...
          DWORD dwBackCount)
{
    ...
    wc.lpszClassName = (LPCWSTR)lpTitle;
    RegisterClass(&wc);
...
//    {
//        // Create comprehensive vertex shader for 3D rendering
...
//    }
//
//    void CompatibilityShaderManager::SetLightmapShaders()
//    {
//        g_D3DContext->VSSetShader(m_defaultVertexShader.Get(), nullptr, 0);
...
//    }
//
//    // Enhanced render state manager with proper state caching
...
//    }
//
//    D3D11_BLEND RenderStateManager::ConvertBlendMode(DWORD chBlend)
//    {
//        switch (chBlend)
//        {
//        case CH_BLEND_ZERO:
...
//    }
//
//    void RenderStateManager::ApplySamplerState(DWORD stage)
//    {
//        D3D11_SAMPLER_DESC samplerDesc = {};
//
//        // Get filter settings
...
//        m_currentState.currentStates[CH_RS_CULLMODE] = CH_CULL_CW;
//        m_currentState.currentStates[CH_RS_ALPHABLENDENABLE] = FALSE;
//        m_currentState.currentStates[CH_RS_LIGHTING] = TRUE;
//        m_currentState.currentStates[CH_RS_AMBIENT] = 0xFFFFFFFF;
//
//        // Set default texture stage states
//        for (int i = 0; i < 8; i++)
//        {
//            m_currentState.currentTextureStates[i][CH_TSS_MINFILTER] = CH_TEXF_LINEAR;
//            m_currentState.currentTextureStates[i][CH_TSS_MAGFILTER] = CH_TEXF_LINEAR;
//            m_currentState.currentTextureStates[i][CH_TSS_MIPFILTER] = CH_TEXF_LINEAR;
//            m_currentState.currentTextureStates[i][CH_TSS_COLOROP] = (i == 0) ? 4 : 1; // MODULATE for stage 0, DISABLE for others
//            m_currentState.currentTextureStates[i][CH_TSS_COLORARG1] = 1; // TEXTURE
//            m_currentState.currentTextureStates[i][CH_TSS_COLORARG2] = 0; // DIFFUSE
//            m_currentState.currentTextureStates[i][CH_TSS_ALPHAOP] = (i == 0) ? 4 : 1; // MODULATE for stage 0, DISABLE for others
//            m_currentState.currentTextureStates[i][CH_TSS_ALPHAARG1] = 1; // TEXTURE
//            m_currentState.currentTextureStates[i][CH_TSS_ALPHAARG2] = 0; // DIFFUSE
//        }
//    }
//
//} // namespace CHInternal
...
// Add this to CH_main.cpp - Fixed render state manager implementation
...
namespace CHInternal {
    ...
    D3D11_STENCIL_OP RenderStateManager::ConvertStencilOp(DWORD chStencilOp)
    {
        switch (chStencilOp)
        {
    ...
    D3D11_COMPARISON_FUNC RenderStateManager::ConvertStencilFunc(DWORD chFunc)
    {
        switch (chFunc)
        {
        case CH_CMP_NEVER:
    ...
    D3D11_TEXTURE_ADDRESS_MODE RenderStateManager::ConvertTextureAddress(DWORD chAddress)
    {
        switch (chAddress)
        {
